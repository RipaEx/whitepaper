...
\draw[anchor=west] (\Gm@lmargin,-9cm) node [line width=2pt,rounded corners=15pt,draw=trolleygrey,fill=white,fill opacity=0.5,inner sep=15pt]{\strut\makebox[22cm]{}};
