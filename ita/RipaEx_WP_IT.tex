...
\begin{tcolorbox}[roadmapBox,
	title=\textsc{Finanziamneto del progetto: XPX presale e RIPA TEC (WP2)}]
...
\begin{tcolorbox}[roadmapBox,
	title=\textsc{Apertura del primo exchange e sviluppo di strumenti e risorse (WP3)}]
...
\begin{tcolorbox}[roadmapBox,
	title=\textsc{Esecuzione/Disseminazione (WP 7/8) e Coordinamento del Progetto (WP1)}]
...
\begin{tcolorbox}[roadmapBox,
	title=\textsc{Sviluppo di un exchange ibrido-decentralizzato (WP 4-6)}]
