...
\begin{description}
	\item[\textsc{Funding the project: XPX presale and RIPA TEC (WP2)}] This phase recognises the existence of interest in this market development
	...
	build the first working prototype of a centralized exchange based on Peatio. \textbf{\textsc{Phase ending January 2019}}.
	\item[\textsc{First exchange opening and development of tools and resources (WP3)}] The second phase takes the results of the first 
	...
	done. \textbf{\textsc{Phase ending June 2019}}.
	\item[\textsc{Development of hybrid-decentralized exchange (WP 4-6)}] Using the tools and resources developed in WP3, 
    ...
    deliverables (e.g. tools) that enable successful and efficient demonstration activities. \textbf{\textsc{Phase ending January 2020}}.
	\item[\textsc{Dissemination (WP 7/8) and Project Coordination (WP1)}] During the full duration of the project, 
...
equal height group=nobefaf,width=(\linewidth-1pt)/3, nobeforeafter,
	center title,
	valign=top, halign=left}}
\begin{tcolorbox}[featureBox,
	title=Open Source]

	\small	All source code are fully released under the terms of the MIT License.\\
...
\begin{tcolorbox}[featureBox,
	...
	\small	International KYC/AML standards.\\
...
\end{tcolorbox}
\begin{tcolorbox}[featureBox,
	title=Transparent \& Configurable]

	\small	Customize in your own way\\
...
\begin{tcolorbox}[featureBox,
	...
	\small	All users are able to view Ripa Exchange in a language to their best convenience.\\
...
\end{tcolorbox}
\begin{tcolorbox}[featureBox,
	title=Multi-Accounts Trading]

	\small	Easy currency configuration.\\
...
\end{tcolorbox}
\begin{tcolorbox}[featureBox,
	title=Multi-Accounts Users]

	\small	Easy account configuration.\\
...
\end{tcolorbox}
\begin{tcolorbox}[featureBox,
	title=Functional \& Intuitive]

	\small	For the new trader, for the experienced trader.\\
