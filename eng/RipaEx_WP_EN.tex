...
\noindent \textit{First printing, March 2018 - version 0.9} % Printing/edition date
...
The industry of virtual currencies has an high entry level from a technical point of view for the average user
...
which you need to pay another \euro100,000.00 - 150,000.00 just to brand it and customize as for your needs so you can tide your 
...
\begin{enumerate}
	...
	\item \textbf{\textsc{what}}: crypto assets are an alternative to centralized assets managed by (country-specific) stock exchanges. Although certain
	...
	\item \textbf{\textsc{how much}}: the average cost for starting your own crypto asses marketplace is around \euro 150,000.00 only for a running instance of your exchange platform:
	...
	\item \textbf{\textsc{what}}: classical types of exchange operations are: 
		...
		\begin{itemize}
			\item \textbf{FIAT $\Leftrightarrow$ CRYPTO exchange}: in which exchanges operations are performed between FIAT\footnote{Traditional central banks owned currencies like EUR, USD, GBP, JPY, others...} 
			currencies and virtual currencies
			\item \textbf{CRYPTO $\Leftrightarrow$ CRYPTO exchange}: in which exchanges operations are performed only between virtual currencies
		\end{itemize}
	...
	\item \textbf{\textsc{how}}: options for finding users for your exchanges operations are: targeted marketing campaigns, innovative features in the industry,
	...
	\item \textbf{\textsc{how}}: for setting-up a crypto asset marketplace a project must take into account the following legislation:
		...
		\end{itemize}
	\item \textbf{\textsc{who}}: the nature of the business under consideration by the Ripa Exchange project (small scale,
	...
	\item \textbf{\textsc{why}}: the arguments for crypto asset marketplaces are for financial freedom, decentralizing of the value-transferring operations, and
	...
	\item \textbf{\textsc{where}}: the two critical factors affecting the cryptocurrency industry are banks concurrence and State banning.
	...
	\item \textbf{\textsc{Recommendations for all/law compliance}}: if you intend to incorporate a FIAT $\Leftrightarrow$ CRYPTO exchange you should
...
\begin{tcbraster}[raster columns=5,raster rows=4,raster height=10cm,
	...
	\tcboxfit{\tcbfontsize{0.8} Support from three agencies, adv campaigns pushing harder, store with RipaEx gadgets}
...
\begin{tcbraster}[raster columns=2,raster rows=4,raster height=10cm,
	...
	1+ years experience in moderating community,\\
...
\begin{itemize}
	...
	\item \textbf{Send Us an e-mail} \href{mailto:info@ripaex.io}{info@ripaex.io}
\end{itemize}
%----------------------------------------------------------------------------------------
%	CHAPTER 8: Legal
%----------------------------------------------------------------------------------------
