...
Per offrire i PRO di un exchange centralizzato come supporto di livello platinum e scambio FIAT, ed i PRO di un exchange 
...
\begin{tcbraster}[raster columns=5,raster rows=4,raster height=10cm,
	...
	\tcboxfit{\tcbfontsize{0.8} Dipartimenti legali al lavoro su standard internazionali AML/KYC a New York,
	Londra ed Hong Kong}
