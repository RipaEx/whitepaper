...
\begin{tikzpicture}[remember picture,overlay]
    \node(background) at (current page.center) {\includegraphics[height=\paperheight]{backgroundES}};
\end{tikzpicture}
\endgroup
...
equal height group=nobefaf,width=(\linewidth-1pt)/3, height=4.2cm, nobeforeafter,
	center title,
	valign=top, halign=left}}
...
\begin{center}
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{RipaExchange_HLPlan.PNG}
	\captionof{figure}{Ripa Exchange Development Timeline}
\end{center}
