...
\noindent \textit{Prima pubblicazione, Marzo 2018 - versione 0.9} % Printing/edition date
...
in questo campo e tu necessiti del codice sorgente per avviarla, codice sorgente che per essere avviata ti deve essere concesso gratuitamente.
...
solo per avere una piattaforma che funzioni e per la quale dovete erogare altri \euro150.000,00-200.000,00 per brandizzarla, personalizzarla
...
sicura, responsiva e produttiva. Questo è il motivo per cui Ripa Exchange si prefigge lo scopo di sviluppare una rete di exchange
...
Il RFT dispone che i fondi delle fasi di Prevendita e RIPA TEC saranno usati esclusivamente per il finanziamento del progetto 
...
\end{itemize}
\todo{TODO: AGGIUNGERE PARTNER RIPAEX}
...
\todo{TODO: DEFINIRE LA GOVERNANCE RIPAEX}
...
\begin{enumerate}
	...
	\item \textbf{\textsc{come}}: per incorporare una crypto asset marketplace un progetto deve tenere in considerazione la seguente legislazione:
		...
		\end{itemize}
	\item \textbf{\textsc{chi}}: la natura dell'attività in considerazione del progetto Ripa Exchange (una rete di piccoli exchange FIAT $\Leftrightarrow$ CRYPTO)
	...
	di economia Austriaca \cite{austrianTheory} 
	\todo{TODO: aggiungere sulla scuola di economia Austriaca}
	\item \textbf{\textsc{perchè}}: benefici delle tecnologie di valuta virtuale 
	\todo{ToDo: aggiungere numeri}
	...
	\todo{TODO: scrivere più in dettaglio questa parte}
...
\section{Visione di Mercato}
	...
	\todo{TODO: riferimenti in bibliografia}
		\begin{itemize}
