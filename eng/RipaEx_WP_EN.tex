...
\begin{description}
	...
	\begin{description}
		\item[Relay nodes] - Nodes with full API functionality, acting as a back-end for the
...
\begin{description}
	...
	\item[Services] ACES Services create and execute Service Contracts, which can be anything from uploading 
